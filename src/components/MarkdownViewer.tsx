...
const MarkdownViewerBase: React.FC<MarkdownViewerProps> = ({
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors custom-scrollbar">
      ...
      <article className="max-w-4xl mx-auto px-6 sm:px-10 pb-24 text-[15px] sm:text-base leading-relaxed tracking-normal font-normal">
        <ReactMarkdown
